namespace ET
{
    ...
    {
        // 场景切换协程
        public static async ETTask SceneChangeTo(Scene zoneScene, string sceneName, long sceneInstanceId , long unitId)
        {
            zoneScene.RemoveComponent<AIComponent>();
            zoneScene.GetComponent<PlayerComponent>().MyId = unitId;
