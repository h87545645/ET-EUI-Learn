...
{
// using
	[ResponseType(nameof(M2G_PlayerEnterMatchResponse))]
	[Message(InnerMessage.G2M_PlayerEnterMatchRequest)]
	[ProtoContract]
	...
	[Message(InnerMessage.M2G_PlayerEnterMatchResponse)]
	[ProtoContract]
	...
	[ResponseType(nameof(M2G_CreateRoomResponse))]
	[Message(InnerMessage.G2M_CreateRoomRequest)]
	[ProtoContract]
	public partial class G2M_CreateRoomRequest: ProtoObject, IActorRequest
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class M2G_CreateRoomResponse: ProtoObject, IResponse
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }
	...
	[Message(InnerMessage.G2M_PlayerEnterRoomRequest)]
	[ProtoContract]
...
//demo follow
	...
	{
		 public const ushort G2M_PlayerEnterMatchRequest = 20002;
		 public const ushort M2G_PlayerEnterMatchResponse = 20003;
		 public const ushort G2M_CreateRoomRequest = 20004;
		 public const ushort M2G_CreateRoomResponse = 20005;
